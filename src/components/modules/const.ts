...
// FETCH ALL MENUS
export const menusUrl = `${process.env.REACT_APP_API_URL}menus`;
export const dessertsUrl = `${process.env.REACT_APP_API_URL}desserts`;
export const saladsUrl = `${process.env.REACT_APP_API_URL}salads`;
